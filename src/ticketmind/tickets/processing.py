...
def create_run(session_factory, runner_factory, ticket_id: UUID, payload: RunCreate, actor_id: str, key: str):
    digest = request_hash(payload)
    with session_factory() as session, session.begin():
        ...
        if ticket.status not in (TicketStatus.OPEN, TicketStatus.AWAITING_CUSTOMER):
